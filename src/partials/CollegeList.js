  ...
  return (
    <div className="w-full h-full">
      <h1 className="text-3xl m-6 font-extrabold text-black dark:text-white sm:text-4xl text-center">
        Nice results, check these colleges for you.
      </h1>
      {colleges && (
        <div className="flex flex-wrap justify-around items-center">
          {colleges.map((college) => (
            <div class="flex-shrink-0 mx-2 mb-6 sm:mb-0 relative overflow-hidden rounded-lg max-w-xs shadow-lg">
              <Link to={"/view/" + college.collegeId}>
